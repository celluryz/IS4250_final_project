...
sample_data_09 <- dplyr::select(origin_data_09, X_STATE, VETERAN2,  AGE, EMPLOY, HTM3, WTKG2, SEX, RACE2, INCOME2, EDUCA, SMOKDAY2, JOBACTIV, X_FRTINDX, X_BMI4)
...
```{r}
smoke <- dplyr::filter(sample_data_all, SMOKDAY2 != 9 & (SMOKDAY2 == 1 | SMOKDAY2 == 2))
...
```{r}
frequentFruit <- dplyr::filter(sample_data_all, X_FRTINDX != 9 & X_FRTINDX == 4)
...
nonfrequentFruit <- dplyr::filter(sample_data_all, X_FRTINDX != 9 & (X_FRTINDX == 1 | X_FRTINDX ==2 | X_FRTINDX == 3))
