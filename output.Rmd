...
ob_pr_race <- dplyr::bind_rows(ob_pr_race, ob_pr_age_other_race)
...
ob_pr_vigorousLTPA_table <- dplyr::bind_rows(vigorousLTPA_pr, nonvigorousLTPA_pr)
...
View(ob_pr_vigorousLTPA_table)
View(ob_pr_vigorousLTPA_table_adjusted)
...
ob_pr_physicalDemandJob_table <- dplyr::bind_rows(physicalDemandJob_pr, nonphysicalDemandJob_pr)
